...
public class App {
    ...
    public static void delayTime(int timeInMs){ 
      //this method will be accessed in the miner class as well.
        ...
        catch(InterruptedException ie){ // EXPLAIN.
          ;
        }
      }
    ...
    public static void main(String[] args) {
      ...
      while(loopVar){ // Everything is in THIS while loop
        ...
        while(true){ // this while loop will pretty much start the game, ask the player to say yes or no, adds to sophistication     
          ...
          delayTime(1000); // calling the delayTime function, substituting 1000 into the parenthesis.
          ...
          delayTime(1000); // back to regular dialogue
